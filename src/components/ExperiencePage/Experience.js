    ...
    return (
        <section className="exp" id='exp'>
            <div className="title" id='title'>
                ...
                <h3 data-aos="fade-down">My Personal Journey</h3>
            </div> 
            <div className="container-exp">
                <div className="education">
                    <h1 data-aos="flip-down">Education</h1>
                    <div data-aos="fade-down" className="course-holder">
                ...
                <div className="work">
                    <h1 data-aos="flip-up">Work</h1>
                    <div data-aos="fade-up" className="job-holder">
